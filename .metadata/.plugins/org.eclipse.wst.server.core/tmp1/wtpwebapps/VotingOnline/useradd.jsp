...
<body>
    <div class="x-body">
        <form class="layui-form" action="UserAddServlet" method="post">
    ...
    <script>
    		...
    		function save(){
    			...
    			if($username == "")
    				...
    				$.post(
    				"/VotingOnline/UserAddServlet",
    				"username="+$username+"&password="+$password+"&name="+$name+"&sex="+$sex+"&phone="+$phone+"&time="+$time,
    				function(result){
    					if(result=='success')
    						{
    							alert("添加成功!");
