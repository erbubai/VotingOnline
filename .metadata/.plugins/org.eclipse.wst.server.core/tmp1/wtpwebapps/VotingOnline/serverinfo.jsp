...
%>
    <div class="x-body">
        <form class="layui-form" action="ServerInfoServlet" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_name" name="name" disabled="" value="<%=name%>" lay-verify="name"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_role" name="role" disabled="" value="<%=role%>" lay-verify="role"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
