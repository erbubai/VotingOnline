 ...
 * Generated at: 2019-12-21 07:50:57 UTC
...
public final class votelist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <a href=\"\">投票管理</a>\r\n");
      out.write("        <a>\r\n");
      out.write("          <cite>投票列表</cite></a>\r\n");
      out.write("      </span>\r\n");
      ...
      out.write("        <form class=\"layui-form layui-col-md12 x-so\" action=\"VoteListServlet\" method=\"post\">\r\n");
      out.write("          <input type=\"text\" id=\"L_title\" name=\"title\"  placeholder=\"请输入投票主题\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("          <button class=\"layui-btn\"  type=\"submit\" ><i class=\"layui-icon\">&#xe615;</i></button>\r\n");
      out.write("        </form>\r\n");
      out.write("      </div>\r\n");
      out.write("      <xblock>\r\n");
      out.write("        <button class=\"layui-btn\" onclick=\"x_admin_show('添加投票','voteadd.jsp',600,400)\"><i class=\"layui-icon\"></i>添加</button>\r\n");
      out.write("      </xblock>\r\n");
 ...
 List<allvote> list=(List<allvote>)request.getAttribute("votelist");
      ...
      out.write("              <span class=\"layui-btn layui-btn-normal layui-btn-mini\">已公开</span></td>\r\n");
      out.write("            <td class=\"td-manage\">\r\n");
      out.write("              <a onclick=\"member_stop(this,'10001')\" href=\"javascript:;\"  title=\"公开\">\r\n");
      out.write("                <i class=\"layui-icon\">&#xe601;</i>\r\n");
      out.write("              </a>\r\n");
      out.write("              <a title=\"编辑\"  onclick=\"x_admin_show('编辑','voteedit.jsp?id=");
      out.print(v.getvId());
      out.write("&title=");
      out.print(v.getvTitle());
      out.write("&name=");
      ...
      out.write("          layer.confirm('确认要私藏吗？',function(index){\r\n");
      out.write("\r\n");
      out.write("              if($(obj).attr('title')=='公开'){\r\n");
      out.write("\r\n");
      out.write("                //发异步把用户状态进行更改\r\n");
      out.write("                $(obj).attr('title','私藏')\r\n");
      out.write("                $(obj).find('i').html('&#xe62f;');\r\n");
      out.write("\r\n");
      out.write("                $(obj).parents(\"tr\").find(\".td-status\").find('span').addClass('layui-btn-disabled').html('已私藏');\r\n");
      out.write("                layer.msg('已私藏!',{icon: 5,time:1000});\r\n");
      out.write("\r\n");
      out.write("              }else{\r\n");
      out.write("                $(obj).attr('title','公开')\r\n");
      out.write("                $(obj).find('i').html('&#xe601;');\r\n");
      out.write("\r\n");
      out.write("                $(obj).parents(\"tr\").find(\".td-status\").find('span').removeClass('layui-btn-disabled').html('已公开');\r\n");
      out.write("                layer.msg('已公开!',{icon: 5,time:1000});\r\n");
      out.write("              }\r\n");
      out.write("              \r\n");
      out.write("          });\r\n");
      out.write("      }\r\n");
      ...
      out.write("    \t\t$.post(\r\n");
      out.write("  \t\t\t\t\"/VotingOnline/VoteDelServlet\",\r\n");
      out.write("  \t\t\t\t\"id=\"+id,\r\n");
      out.write("  \t\t\t\tfunction(result){\r\n");
      out.write("  \t\t\t\t\tif(result=='success')\r\n");
      out.write("  \t\t\t\t\t\t{\r\n");
      out.write("  \t\t\t\t\t\t\talert(\"删除成功!\");\r\n");
      out.write("  \t\t\t\t\t\t\twindow.location.href=\"/VotingOnline/VoteListServlet\"\r\n");
      out.write("  \t\t\t\t\t\t}\r\n");
      out.write("  \t\t\t\t},\r\n");
      out.write("  \t\t\t\t\"text\")\r\n");
      out.write("        }\r\n");
