...
%>
    <div class="x-body">
        <form class="layui-form" action="RoleEditServlet" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_rit" name="rit" required="" value="<%=rit%>" lay-verify="rit"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_des" name="des" required="" value="<%=des%>" lay-verify="describe"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
	...
	function save(){
		...
		if($role == "")
			...
			"id="+$id+"&role="+$role+"&rit="+$rit+"&des="+$des,
			function(result){
				if(result=='success')
					{
						alert("修改成功!");
