...
<body>
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="VoteListServlet" method="post">
          <input type="text" id="L_title" name="title"  placeholder="请输入投票主题" autocomplete="off" class="layui-input">
