...
public class ServerAddServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String sql="insert into server(name,username,password,role,time)"+
				" value('"+name+"','"+username+"','"+password+"','"+role+"','"+time+"')";
		String sql1="select username from server where username='"+username+"'";
		try{
